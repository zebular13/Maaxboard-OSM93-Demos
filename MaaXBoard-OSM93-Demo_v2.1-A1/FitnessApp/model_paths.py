...
CPU_MODELS = {
    # 'DETECT_MODEL': 'pose_detection_128x128_full_integer_quant.tflite',
    # 'LANDMARK_MODEL': 'pose_landmark_upper_body_256x256_full_integer_quant.tflite'
    'DETECT_MODEL': 'pose_detection_full_quant.tflite',
    'LANDMARK_MODEL': 'pose_landmark_full_quant.tflite'
}
