...
import signal
import time
from dms.DMSmain import InitDMSmain
from dms.DMSmain import DMSExit
from dms.DMSmain import GetFrame
...
async def video_feed(request):
	...
	if sys.implementation.name != 'micropython':
		...
		async def stream():
			...
			while True:
				frame = await asyncio.get_running_loop().run_in_executor(None, GetFrame)
